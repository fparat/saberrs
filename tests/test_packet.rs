...
mod checksum {
    ...
    fn set_speed() {
        let vectors = [
            (1, -100.0, b"\x80\x28\x01\x29\x7f\x0f\x4d\x31\x0c".to_vec()),
            (2, -50.0, b"\x80\x28\x01\x29\x7f\x07\x4d\x32\x05".to_vec()),
            (1, 0.0, b"\x80\x28\x00\x28\x00\x00\x4d\x31\x7e".to_vec()),
            (1, 25.0, b"\x80\x28\x00\x28\x7f\x03\x4d\x31\x00".to_vec()),
            (2, 50.0, b"\x80\x28\x00\x28\x7f\x07\x4d\x32\x05".to_vec()),
            (1, 75.0, b"\x80\x28\x00\x28\x7f\x0b\x4d\x31\x08".to_vec()),
            (2, 100.0, b"\x80\x28\x00\x28\x7f\x0f\x4d\x32\x0d".to_vec()),
        ];
    ...
    fn set_speed_errs() {
        ...
        saberchecksum.set_speed(1, 100.01).expect_err("Values >100.0 should fail");
        saberchecksum.set_speed(1, -100.01).expect_err("Values <-100.0 should fail");
    ...
    fn set_drive() {
        let vectors = [
            (-50.0, b"\x80\x28\x01\x29\x7f\x07\x4d\x44\x17".to_vec()),
            (100.0, b"\x80\x28\x00\x28\x7f\x0f\x4d\x44\x1f".to_vec()),
        ];
    ...
    fn set_turn() {
        let vectors = [
            (-100.0, b"\x80\x28\x01\x29\x7f\x0f\x4d\x54\x2f".to_vec()),
            (25.0, b"\x80\x28\x00\x28\x7f\x03\x4d\x54\x23".to_vec()),
        ];
        let (mut saberchecksum, mut tty) = utils::saberchecksum_harness();
    ...
    #[rustfmt::skip]
    fn set_power() {
        let vectors = [(1, -100.0, b"\x80\x28\x01\x29\x7f\x0f\x50\x31\x0f".to_vec())];
    ...
    #[rustfmt::skip]
    fn set_ramp() {
        let vectors = [(1, 25.0, b"\x80\x28\x00\x28\x7f\x03\x52\x31\x05".to_vec())];
    ...
    #[rustfmt::skip]
    fn set_aux() {
        let vectors = [(2, 50.0, b"\x80\x28\x00\x28\x7f\x07\x51\x32\x09".to_vec())];
    ...
    fn get_speed() {
        #[rustfmt::skip]
            let vectors = [
            (1, b"\x80\x29\x00\x29\x4D\x31\x7E".to_vec(), b"\x80\x49\x00\x49\x7F\x03\x4D\x31\x00".to_vec(), 24.963),
            (2, b"\x80\x29\x00\x29\x4D\x32\x7F".to_vec(), b"\x80\x49\x01\x4A\x2E\x08\x4D\x32\x35".to_vec(), -52.2716),
        ];
...
mod crc {
    ...
    fn set_speed() {
        let vectors = [
            (1,  -100.0, b"\xf0\x28\x01\x20\x7f\x0f\x4d\x31\x51\x3b".to_vec()),
            (2,  -50.0,  b"\xf0\x28\x01\x20\x7f\x07\x4d\x32\x65\x6c".to_vec()),
            (1,  0.0,    b"\xf0\x28\x00\x0c\x00\x00\x4d\x31\x66\x5c".to_vec()),
            (1,  25.0,   b"\xf0\x28\x00\x0c\x7f\x03\x4d\x31\x74\x5f".to_vec()),
            (2,  50.0,   b"\xf0\x28\x00\x0c\x7f\x07\x4d\x32\x65\x6c".to_vec()),
            (1,  75.0,   b"\xf0\x28\x00\x0c\x7f\x0b\x4d\x31\x32\x18".to_vec()),
            (2,  100.0,  b"\xf0\x28\x00\x0c\x7f\x0f\x4d\x32\x23\x2b".to_vec()),
        ];
    ...
    fn set_speed_errs() {
        ...
        sabercrc.set_speed(1, 100.01).expect_err("Values >100.0 should fail");
        sabercrc.set_speed(1, -100.01).expect_err("Values <-100.0 should fail");
    ...
    fn set_drive() {
        let vectors = [
            (-50.0, b"\xf0\x28\x01\x20\x7f\x07\x4d\x44\x1b\x76".to_vec()),
            (100.0, b"\xf0\x28\x00\x0c\x7f\x0f\x4d\x44\x5d\x31".to_vec()),
        ];
    ...
    fn set_turn() {
        let vectors = [
            (-100.0, b"\xF0\x28\x01\x20\x7f\x0f\x4d\x54\x03\x39".to_vec()),
            (25.0, b"\xF0\x28\x00\x0c\x7f\x03\x4d\x54\x26\x5d".to_vec()),
        ];
        let (mut sabercrc, mut tty) = utils::sabercrc_harness();
    ...
    #[rustfmt::skip]
    fn set_power() {
        let vectors = [(1, -100.0, b"\xf0\x28\x01\x20\x7f\x0f\x50\x31\x6e\x1a".to_vec())];
    ...
    #[rustfmt::skip]
    fn set_ramp() {
        let vectors = [(1, 25.0, b"\xf0\x28\x00\x0c\x7f\x03\x52\x31\x0a\x6e".to_vec())];
    ...
    #[rustfmt::skip]
    fn set_aux() {
        let vectors = [(2, 50.0, b"\xf0\x28\x00\x0c\x7f\x07\x51\x32\x0a\x00".to_vec())];
    ...
    fn get_speed() {
        #[rustfmt::skip]
            let vectors = [
            (1, b"\xF0\x29\x00\x6D\x4D\x31\x06\x24".to_vec(), b"\xF0\x49\x00\x15\x00\x0C\x4D\x31\x43\x38".to_vec(), 75.03664),
            (2, b"\xF0\x29\x00\x6D\x4D\x32\x74\x34".to_vec(), b"\xF0\x49\x01\x39\x6B\x05\x4D\x32\x4C\x58".to_vec(), -36.492_428),
        ];
